/*
	...
	~Program Description: The purpose of this assignment is to learn to develop multi-process
	programs. You are expected to extend the myshell.c program and add pipelines and I/O redirections.
	This program recognize ">", ">>", "<", "|", which will write to a file, append to a file, read
	input form a file, and pipe outputs.
*/
...
/*
	This function will parse the file interaction part of the command. 
...
/*
	This function will fork those commands into different child processes. 
